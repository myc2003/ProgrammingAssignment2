...
## retrieves the inverse of the matrix from the cache and does not perform
## the computation.  Otherwise, the function calculates the inverse of
## the matrix and sets the value of the inverse of the matrix using the
## setinverse function.
